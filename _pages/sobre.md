...
Animações são um ótimo meio para a comunicação de ideias abstratas. Assim, o Emergir disponibiliza [vídeos animadados](https://emergir.co/cursos/). Este conteúdo está disponível em redes de relações que enfatizam as conexões entre os diferentes tópicos.
...
O portal também serve como vitrine para projetos relevantes à exploração do paradigma da complexidade, como por exemplo o [ISMAPA](https://www.emergir.co/ismapa/) - Mapeamento e Análise da Rede de bolsistas do Instituto Social para Motivar, Apoiar e Reconhecer Talentos ([Ismart](http://www.ismart.org.br/))."
